	...
	tests := []Test{
		{
			...
			expected: []literal.Option{
				literal.Ok(literal.New("123", 1, 1, 4)),
				literal.Ok(literal.New(";", 1, 4, 5)),
				literal.Ok(literal.New(",", 1, 5, 6)),
				literal.Ok(literal.New("zcxc", 1, 6, 10)),
				literal.Ok(literal.New(",", 1, 10, 11)),
				literal.Ok(literal.New("t", 1, 11, 12)),
				literal.Ok(literal.New(",", 1, 12, 13)),
				literal.Ok(literal.New(",", 1, 13, 14)),
				literal.Ok(literal.New("czxc", 1, 14, 18)),
				literal.Ok(literal.New(",", 1, 18, 19)),
		...
		},
		{
			...
			input: "asd\t\nsa\r\na__sd21s\v123",
			expected: []literal.Option{
				literal.Ok(literal.New("asd", 1, 1, 4)),
				literal.Ok(literal.New("\t", 1, 4, 5)),
				literal.Ok(literal.New("\n", 1, 5, 6)),
				literal.Ok(literal.New("sa", 2, 1, 3)),
				literal.Ok(literal.New("\n", 2, 3, 4)),
				literal.Ok(literal.New("a__sd21s", 3, 1, 9)),
				literal.Ok(literal.New("\v", 3, 9, 10)),
				literal.Ok(literal.New("123", 3, 10, 13)),
				literal.Ok(literal.New("\n", 3, 13, 14)),
			},
		},
	}
